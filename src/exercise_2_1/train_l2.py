...
# folosim doar coloanele selectate + produsele (vectorul de produse)
...
# standardizare + eliminare coloane constante/duplicate
...
models_to_save = {
    "ft_GD_lr0.2_iter900": model,
    "ft_Newton_lr0.1_iter10": model1,
}
...
pd.DataFrame(all_results).to_csv("../../result_metrics/results_metrics_ft.csv", index=False, encoding="utf-8-sig")
